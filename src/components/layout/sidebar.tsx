...
const SidebarItem = ({ href, icon, label, roles }: SidebarItemProps) => {
  ...
  return (
    <Link
      href={href}
      className={cn(
        "flex items-center gap-3 rounded-lg px-3 py-2 text-gray-800 transition-all hover:text-gray-900",
...
export function Sidebar() {
  return (
    <div className="flex h-full w-64 flex-col border-r bg-gradient-to-b from-gray-900 to-gray-800 text-white">
      <div className="flex h-16 items-center border-b border-gray-700/50 bg-gradient-to-r from-blue-600 to-indigo-600 px-4">
        <Link href="/dashboard" className="flex items-center gap-2 font-semibold">
          <span className="text-xl text-white">Tawania Admin</span>
        </Link>
      </div>
