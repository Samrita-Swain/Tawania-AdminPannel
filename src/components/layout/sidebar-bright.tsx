...
export function Sidebar() {
  ...
  return (
    <>
        ...
        <ul className="flex flex-col gap-2.5">
          ...
          <li className="mt-8">
            <div className="mb-3 flex items-center">
              <div className="h-0.5 flex-grow bg-gradient-to-r from-green-200 to-transparent"></div>
              <h3 className="mx-2 text-xs font-bold text-green-700 uppercase tracking-wider">
                Store Management
              </h3>
          ...
          <li className="mt-8">
            <div className="mb-3 flex items-center">
              ...
              <h3 className="mx-2 text-xs font-bold text-pink-700 uppercase tracking-wider">
          ...
          <li className="mt-8">
            <div className="mb-3 flex items-center">
              <div className="h-0.5 flex-grow bg-gradient-to-r from-orange-200 to-transparent"></div>
              <h3 className="mx-2 text-xs font-bold text-orange-700 uppercase tracking-wider">
                Transfer Management
              </h3>
              <div className="h-0.5 w-5 bg-orange-200"></div>
            </div>
            <ul className="flex flex-col gap-1.5">
              <li>
                <SidebarItem
          ...
          <li className="mt-8">
            <div className="mb-3 flex items-center">
              <div className="h-0.5 flex-grow bg-gradient-to-r from-purple-200 to-transparent"></div>
              <h3 className="mx-2 text-xs font-bold text-purple-700 uppercase tracking-wider">
                Customer Management
              </h3>
              <div className="h-0.5 w-5 bg-purple-200"></div>
            </div>
            <ul className="flex flex-col gap-1.5">
              <li>
                <SidebarItem
          ...
          <li className="mt-8">
            <div className="mb-3 flex items-center">
              <div className="h-0.5 flex-grow bg-gradient-to-r from-indigo-200 to-transparent"></div>
              <h3 className="mx-2 text-xs font-bold text-indigo-700 uppercase tracking-wider">
                System
              </h3>
              <div className="h-0.5 w-5 bg-indigo-200"></div>
            </div>
            <ul className="flex flex-col gap-1.5">
              <li>
                <SidebarItem
      ...
      <div className="bg-gradient-to-t from-gray-50 to-white p-5">
        <Link
          href="/auth/logout"
