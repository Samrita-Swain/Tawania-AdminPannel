  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.error || "Failed to create inward movement");
      }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-gray-800">New Inward Movement</h1>
        <Button
          variant="outline"
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="e.g., PO-001, RET-001"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                placeholder="Additional notes about this inward movement"
                rows={3}
              />
            </div>
          </CardContent>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => handleItemChange("batchNumber", e.target.value)}
                  ...
                  <div key={index} className="flex items-center justify-between border rounded-lg p-4">
                    <div className="flex-1">
                      ...
                      <div className="flex gap-2 mt-1">
                        ...
                        {item.batchNumber && <Badge variant="outline">Batch: {item.batchNumber}</Badge>}
                        {item.expiryDate && <Badge variant="outline">Exp: {item.expiryDate}</Badge>}
                      </div>
                    </div>
                    <Button
                      type="button"
        ...
        <div className="flex justify-end gap-2">
          ...
          >
            {isSubmitting ? "Creating..." : "Create Inward Movement"}
          </Button>
        </div>
      </form>
    </div>
